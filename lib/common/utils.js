...
var coin = this.coin || 'btc'

var PrivateKey = Bitcore_[coin].PrivateKey;
var PublicKey = Bitcore_[coin].PublicKey;
var crypto = Bitcore_[coin].crypto;
var encoding = Bitcore_[coin].encoding;
...
Utils.privateKeyToAESKey = function(privKey) {
  ...
  return Bitcore_[coin].crypto.Hash.sha256(pk.toBuffer()).slice(0, 16).toString('base64');
};
